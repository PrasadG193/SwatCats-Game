...
class func:
	...
	cat1=pygame.image.load('Resources/catch1.png')	
	cat2=pygame.image.load('Resources/catch2.png')
	cat3=pygame.image.load('Resources/catch3.png')
	...
	gp=0
	pwe=[]
	power=pygame.image.load('Resources/power.png')
	pox=1366
	def fun(x):
...
swat=[]
swat_run2=pygame.image.load('Resources/swat-run4.png')
swat.append(swat_run2)
swat_run3=pygame.image.load('Resources/swat-run5.png')
swat.append(swat_run3)
swat_run4=pygame.image.load('Resources/swat-run6.png')
swat.append(swat_run4)
swat_run1=pygame.image.load('Resources/swat-run3.png')
swat.append(swat_run1)

swat_jump1=pygame.image.load('Resources/swat-jump1.png')
swat.append(swat_jump1)
swat_jump2=pygame.image.load('Resources/swat-jump2.png')
swat.append(swat_jump2)
swat_jump3=pygame.image.load('Resources/swat-jump3.png')
swat.append(swat_jump3)
swat_jump4=pygame.image.load('Resources/swat-jump4.png')
swat.append(swat_jump4)

won=pygame.image.load("Resources/win.png")
lost=pygame.image.load("Resources/lost.png")

fire=[]
fire1=pygame.image.load('Resources/1.png')
fire.append(fire1)
fire2=pygame.image.load('Resources/2.png')
fire.append(fire2)
fire3=pygame.image.load('Resources/3.png')
fire.append(fire3)
fire4=pygame.image.load('Resources/4.png')
fire.append(fire4)


vill_bull=pygame.image.load('Resources/cat4.png')
pl_bull=pygame.image.load('Resources/bul1.png')

back=pygame.image.load('Resources/level2_back.jpg')


player = pygame.Rect(450,300-46, 58, 50)

villain=pygame.image.load('Resources/dark.png')
#print swat
